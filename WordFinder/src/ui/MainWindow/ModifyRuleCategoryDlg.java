...
public class ModifyRuleCategoryDlg extends Dialog {
	 ...
	 * @param parentShell
	 */
	public ModifyRuleCategoryDlg(Shell parentShell, String categoryName) {
		super(parentShell);
	...
	protected void buttonPressed(int buttonId) {
		if(IDialogConstants.CANCEL_ID == buttonId)
			...
			if(name.equals(categoryName)){
			...
			else if(MainWindow.cp.isCategoryExisted(name)){
				...
				MainWindow.cp.updateCategoryName(name, categoryName);
				MainWindow.rp.updateRuleCategory(name, categoryName);
				close();
			}
		}
	}
