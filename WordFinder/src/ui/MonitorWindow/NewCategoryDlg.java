...
public class NewCategoryDlg extends Dialog {
	 ...
	 * @param parentShell
	 */
	public NewCategoryDlg(Shell parentShell) {
		super(parentShell);
	}
	...
	protected void buttonPressed(int buttonId) {
		if(IDialogConstants.CANCEL_ID == buttonId)
			...
			if(MainWindow.ucp.isCategoryExisted(name)){
				...
				MainWindow.ucp.insertNewCategory(name);
				close();
			}
		}
	}
